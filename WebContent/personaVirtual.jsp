...
<%-- 										result_html+="<tr><td><a href='<%=getServletConfig().getServletContext().getInitParameter("vitualPersonaImgPath") %>"+item.PersonaCode+".png' target='_blank' onclick=''>"+item.PersonaCode+"</a></td></tr>"; --%>
// 									});
...
<!-- <h2 class="page-title">虛擬目標客群定位</h2> -->
