...
<script>
	...
	function show_chart(chartOptions, isChart) {
		...
		if(window.scenario_record){scenario_record("動態統計-國家","[ '"+$("#country").val()+"', '"+$("#structure").val()+"', '"+$("#dimensions").val()+"', '"+$("#target").val()+"', ["+second_target_list+"], ["+type_list+"]]","selector","#view",function(){ 
